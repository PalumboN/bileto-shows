...
app.controller('TuentradaController', TuentradaController)
...
app.directive('tuentradaPerformance', function() { return { templateUrl: 'directives/tuentrada-performance.html' }})
